...
import org.example.domain.authenticate.UserAuthenticateDTO;
...
public class LoginServiceImpl implements LoginService {
    ...
    public ResponseResult login(User user) {
        ...
        UserAuthenticateDTO userDTO = new UserAuthenticateDTO(loginUser.getUser().getId(), loginUser.getUser().getUsername(), loginUser.getUser().getName(), loginUser.getPermissions());
    ...
    public ResponseResult getEmailCode(String email) {
        ...
        ResponseResult<User> result = userFeignClient.selectByEmail(email);
    ...
    @Override
    public ResponseResult<User> registerPersonal(User user) {
